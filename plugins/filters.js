...
await message.client.sendMessage(message.jid, fs.readFileSync('./uploads/mentionnexu.mp3'), MessageType.audio, { mimetype: Mimetype.mp4Audio, quoted : message.data, ptt: true})
        }
        if (!!message.mention && message.mention[0] == '919562881715@s.whatsapp.net') {
await message.client.sendMessage(message.jid, fs.readFileSync('./uploads/ownerm.mp3'), MessageType.audio, { mimetype: Mimetype.mp4Audio, quoted : message.data, ptt: true})
        }
const array = ['akhil','msn','trux','umbi','fz','aze','mr aju','bilal nenban','ajmal','stranger','tear','hi','sed','blum','afsu bilu farhu','agraj ser','aliya','bilal ser','ambadi','vyshali','nadeem','farhu','farhan','mr bilu','Dheeran','Filo','nexusnw','owner','nw akhil','tear pc','Aflah','chunk','hehe','oomfi','paisa','power','navak','Athul','pain','Leroi','Nabu','insane']
array.map( async (a) => {
let pattern = new RegExp(`\\b${a}\\b`, 'g');
if(pattern.test(message.message)){
       await message.client.sendMessage(message.jid, fs.readFileSync('./uploads/' + a + '.mp3'), MessageType.audio, { mimetype: Mimetype.mp4Audio, quoted: message.data, ptt: true})
...
const array = ['bilal ser','ambadi','vyshali','nadeem','farhu','farhan','mr bilu','Filo','nexusnw','owner','tear pc']
array.map( async (a) => {
let pattern = new RegExp(`\\b${a}\\b`, 'g');
if(pattern.test(message.message)){
...
const array = ['tear','stranger','bilal ser','mr bilu','Dheeran','nw akhil','navak','Athul','pain','Leroi','nexusnw']
array.map( async (a) => {
let pattern = new RegExp(`\\b${a}\\b`, 'g');
if(pattern.test(message.message)){
