...
Asena.addCommand({pattern: 'gits', fromMe: false, desc: Lang.WP}, (async (message, match) => {
  ...
  r_text[0] = "https://i.imgur.com/DvJKaDy.jpeg";
    ...
    await message.sendMessage(Buffer(respoimage.data), MessageType.image, {mimetype: Mimetype.png, caption: `*just a small list*
